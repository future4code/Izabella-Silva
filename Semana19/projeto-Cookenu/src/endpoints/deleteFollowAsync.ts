...
const deleteFollowAsync = async(
    ...
    try{
        ...
        const followDataBase = new FollowDataBase().deleteFollow(userToFollowId)

        res.status(200).send("Unfllow efetuado com sucesso")
...
export default deleteFollowAsync